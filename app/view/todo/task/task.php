...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-start action-task">
            <form action="//<?= APP_BASE_PATH ?>/todo/task/update-status/<?php echo $task['id']; ?>" method="post" class="me-2">
            ...
            <a href="//<?= APP_BASE_PATH ?>/todo/task/delete/<?php echo $task['id']; ?>" class="btn btn-danger me-2">Delete</a>
        </div>
    </div>
</div>
